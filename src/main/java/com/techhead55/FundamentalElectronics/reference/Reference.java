package com.techhead55.FundamentalElectronics.reference;
public class Reference {
    public static final String MOD_ID = "FundamentalElectronics";
    public static final String MOD_NAME = "Fundamental Electronics";
    ...
    public static final String CREATIVE_TAB_UNLOCALISED_NAME = "FETAB";
}
